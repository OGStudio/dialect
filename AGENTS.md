...
generator/         The Swift port of the Klin code generator (tool)
  ver-mac/         SPM package (macOS 13+, no external dependencies)
    ...
    tmp.dialect.swift   Hand-written register/set funcs, oneliners (temp, will be generated). Should funcs NO LONGER hand-written — they are generated into dialect.swift by `outShoulds` (see chicken-egg below)
...
example/           Sample macOS SwiftUI app + its own dialect.yml (a self-contained 2nd generation target)
  ...
  src/tmp.dialect.swift  register/set/oneliners funcs only (should funcs are generated into dialect.swift)
